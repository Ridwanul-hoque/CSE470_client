...
import { FaEdit, FaHistory, FaMedal, FaShoppingCart, FaTimes } from "react-icons/fa";
        ...
        <div className="min-h-screen bg-gray-100 py-8 px-4">
            <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                    <div className="bg-[#0D0D2B]  text-white p-6">
                        <div className="flex justify-between items-center">
                            <h1 className="text-2xl font-bold">My Dashboard</h1>
                            <button
                                onClick={handleEditProfile}
                                className="bg-[#FE5F75] text-[#0D0D2B] px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-white transition-all"
                            >
                                <FaEdit /> Edit Profile
                            </button>
                        </div>
                    ...
                    <div className="p-6 md:flex gap-6">
                        <div className="md:w-1/3 mb-4 md:mb-0 flex flex-col items-center">
                            <div className="w-40 h-40 rounded-full overflow-hidden mb-4 border-4 border-[#FE5F75]">
                                <img
                            ...
                            <div className="mt-4 bg-[#FE5F75] bg-opacity-20 p-3 rounded-lg w-full">
                                <div className="flex items-center justify-center gap-2">
                                    <FaMedal className="text-[#FE5F75]" />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    <div className="flex items-center gap-2 mb-3">
                                        <FaHistory className="text-[#0D0D2B]" />
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    <div className="flex items-center gap-2 mb-3">
                                        <FaShoppingCart className="text-[#0D0D2B]" />
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-2xl shadow-lg w-full max-w-md">
                        <div className="flex justify-between items-center p-4 border-b">
                            <h2 className="text-xl font-bold text-[#0D0D2B]">Edit Profile</h2>
                            <button
                        ...
                        <form onSubmit={handleSubmit} className="p-6">
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#0D0D2B] focus:outline-none"
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 bg-[#0D0D2B]  text-white rounded-lg hover:bg-[#3a2722] transition-all ${modalLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                                >
